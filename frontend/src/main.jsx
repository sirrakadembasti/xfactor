...
import './index.css'
import { API_BASE_URL, buildApiUrl, buildSessionRequestOptions } from './services/api.js'
...
class ErrorBoundary extends React.Component {
  ...
  handleReset = async () => {
    try {
      ...
      // Backend erişilemese bile sayfa yenileme hesap kapsamlı React state'ini temizler.
    }
        ...
        <div className="flex items-center justify-center h-screen bg-slate-100 font-sans p-6">
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-slate-200 text-center">
            ...
            <p className="text-xs text-slate-600 mb-6">
              Sunucu oturumunu kapatıp uygulamayı yeniden yükleyin.
            </p>
