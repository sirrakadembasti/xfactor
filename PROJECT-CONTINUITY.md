...
current_task: P0-A Task 5 - Rejection Recording, Durable Repair Issues and Checkpoint Invalidation
status: pending
branch: master
head_commit: SELF
...
blocked_by: []
next_action: Read P0-A Task 5, write the failing isolated rejection test, and run the RED command
...
1. Write the isolated P0-A rejection-recording RED test.
...
Read P0-A Task 5, write the failing isolated rejection test, and run the RED command.
