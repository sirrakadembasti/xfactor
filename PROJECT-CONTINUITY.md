...
current_task: P0-A Task 4 - Stack Capability Verification and capability_blocked State
status: pending
branch: master
head_commit: SELF
...
blocked_by: []
next_action: Read P0-A Task 4, write the failing isolated capability test, and run the RED command
...
1. Write the isolated P0-A capability-check RED test.
...
Read P0-A Task 4, write the failing isolated capability test, and run the RED command.
