...
current_task: P2 Task 1 - Domain/Entity/Use Verification (Step P2.1.2: Verify Entity Queries in Source Code)
status: pending
branch: master
head_commit: SELF
...
blocked_by: []
next_action: Read P2 Step P2.1.2, write the failing isolated entity query test, and run the RED command: node backend/tests/test_p2_domain_policy.js --test=entity-query
...
1. Read P2 Step P2.1.2 and write the isolated entity query RED test.
2. Implement Step P2.1.2 only after RED is observed.
...
Read P2 Step P2.1.2, write the failing isolated entity query test, and run the RED command: node backend/tests/test_p2_domain_policy.js --test=entity-query
