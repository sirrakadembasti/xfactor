...
async function runE2E() {
    ...
    // 6. TESTER VE KONSOLİDE RAPOR
    const testerResult = {
        approved: true,
        summary: "Kabul kriterleri başarıyla doğrulandı. 4 dosya hatasız üretildi."
    };
    ...
    console.log("  ✓ Tester: Final kabul raporu (RAPOR.md) yazıldı.");
